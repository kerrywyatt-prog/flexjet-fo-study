(() => {
        ...
        <main class="content">
          ...
          <div class="shelf-list">
            ...
            <button type="button" class="shelf-item" data-nav="/indoc/135/quiz">
              <span class="name">Quiz · Academy mock exam</span>
              <span class="meta">50 questions · pass 80%</span>
              ${svg('chev')}
            </button>
          </div>
        </main>
  ...
  async function viewIndoc135Quiz() {
    ...
    const paintStart = () => {
      ...
      bindNav();
      $('#sg-start-quiz')?.addEventListener('click', () => {
    ...
    const paintRun = () => {
      ...
      app.innerHTML = `
        <div class="${shellClass()}">
          ...
          <main class="content">
            ...
            <div class="sg-qmeta"><span class="sg-qn">Q${q.n}</span><span class="muted">${quizRun.idx + 1} / ${quizRun.Q.length}</span></div>
      ...
      $('#sg-quiz-next')?.addEventListener('click', () => {
        ...
        if (quizRun.idx === quizRun.Q.length - 1) { paintResult(); return; }
        quizRun.idx++;
        paintRun();
      });
    };
